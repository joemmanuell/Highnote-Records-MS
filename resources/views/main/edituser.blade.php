                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form  action="{{route('main.updateuser', ['user'=>$user])}}" method="PUT" class="user">
                                @csrf
                                @method('PUT') 
                                <div class="form-group row">
                                   <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="name" name="firstname" class="form-control form-control-user" placeholder="First Name" value="{{$user->firstname}}">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row col-sm-6">
                                        <input type="text" name="role" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Level" value="{{$user->role}}">
                                </div>
                                <div class="form-group">
                                        <input type="submit" name="register" class="btn btn-danger btn-user btn-block"
                                            id="exampleRegister" value="Change Details">
                                </div>
